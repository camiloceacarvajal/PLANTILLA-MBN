                ...
                for sublayer in sublayers:
                    ...
                    if sub_vlayer.isValid():
                        if sub_vlayer.crs() != self.target_crs:
                            ...
                            base_renderer = QgsSingleSymbolRenderer(QgsFillSymbol.createSimple({'color': 'rgba(255, 255, 255, 0.5)', 'outline_color': '#0059ff', 'outline_width': 0.98}))
...
#Version septiembre-2024-23-08-experimental